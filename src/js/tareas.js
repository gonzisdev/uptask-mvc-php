(function() {
    ...
    function mostrarFormulario(editar = false, tarea = {}){
        ...
        modal.innerHTML = `
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    <label>Tarea</label>
                    <input type="text" name="tarea" id="tarea" placeholder="${tarea.nombre ? 'Editar la tarea' : 'Añadir tarea al proyecto'}" value="${tarea.nombre ? tarea.nombre : ''}"/>
                </div>
                <div class="opciones">
        ...
        modal.addEventListener('click', e =>{
            ...
            if (e.target.classList.contains('submit-nueva-tarea')) {
                ...
                if (nombreTarea === '') {
                    ...
                    mostrarAlerta('El campo no puede ir vacío', 'error', document.querySelector('.formulario legend'));
                    return;
                }
    ...
    async function agregarTarea(tarea){
        ...
        try {
            const url = 'http://uptask/api/tarea';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
    ...
    async function actualizarTarea(tarea){
        ...
        try {
            const url = 'http://uptask/api/tarea/actualizar';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
    ...
    async function eliminarTarea(tarea) {
        ...
        try {
            const url = 'http://uptask/api/tarea/eliminar';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
